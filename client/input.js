{
  mode: 'development',
  context: 'D:\\workspace\\hotpoint\\client',
  node: {
    setImmediate: false,
    process: 'mock',
    dgram: 'empty',
  ...
  output: {
    path: 'D:\\workspace\\hotpoint\\client\\dist',
  ...
  resolve: {
    alias: {
      '@': 'D:\\workspace\\hotpoint\\client\\src',
    ...
    rules: [
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: 'D:\\workspace\\hotpoint\\client\\node_modules\\cache-loader\\dist\\cjs.js',
            options: {
              cacheDirectory: 'D:\\workspace\\hotpoint\\client\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: 'cb045a94'
            }
          },
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '01dee423',
              emitWarning: true,
              emitError: false,
              eslintPath: 'D:\\workspace\\hotpoint\\client\\node_modules\\eslint',
              formatter: undefined
            }
          }
        ]
